...
<script>
	...
	function friend_view() {
	var div = document.getElementById("body_container");
	div.innerHTML = '<iframe style="width:100%;height:100%;border-radius: 25px;margin-left:10px;margin-right:10px" frameborder="0" src="' + "friends.php" + '" />';
	...
	function pending_establishments() {
	var div = document.getElementById("body_container");
	div.innerHTML = '<iframe style="width:100%;height:100%;border-radius: 25px;margin-left:10px;margin-right:10px" frameborder="0" src="' + "establish.php" + '" />';
	
	}
	
	function complaints_view() {
	var div = document.getElementById("body_container");
	div.innerHTML = '<iframe style="width:100%;height:100%;border-radius: 25px;margin-left:10px;margin-right:10px" frameborder="0" src="' + "complaints.php" + '" />';
...
<div class="titlebar">Service Personnal Portal</div>
...
<div class="sidebar">
  ...
  <a href="#manager_view"><div class="round-button"onclick="profile()"><i class="fa fa-user-circle-o"></i> | My Account</div></a>
  <a href="#staff_view"><div class="round-button"onclick="complaints_view()"><i class="fa fa-frown-o"></i> | Complaints</div></a>
  <a href="#service_persons"><div class="round-button"onclick="pending_establishments()"><i class="fa fa-wrench"></i> | Establish</div></a>
  <a href="#account"><div class="round-button"onclick="salary_view()"><i class="fa fa-money"></i> | Salary</div></a>
    <a href="#site"><div class="round-button"onclick="friend_view()"><i class="fa fa-group"></i> | Friends</div></a>
