<?php
session_start();
$query = "SELECT * FROM CUSTOMER WHERE Cus_ID = '" . $_SESSION['user_2'] . "'";
...
echo "<td><a href='credential_edit.php?Cus_ID=".$row['Cus_ID']."'><img src='./images/icons8-Edit-32.png' alt='Edit'></a></td>";
