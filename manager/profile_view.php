  ...
  <body>
    <div class="container">
		  ...
		  <?php
			...
			if (!$result2) {
				...
				while($rowData2 = mysqli_fetch_array($result2)){
					echo '<h1 class="card-title" >Manager</h1>';
					echo '<p3 class ="card-text">Grade : '.$rowData2["Grade"].' | ID  : '.$_SESSION['user_3'].'</p3>';
      ...
      <div class="card">
		...
		<?php
			include("config.php");
			$sql = "SELECT * FROM EMPLOYEE WHERE Emp_ID = '" . $_SESSION['user_3'] . "'";
