...
$current_year = date('Y');
?>
<h3 style="font-family: Montserrat; margin-left: 5%;">Account Information - Staff</h3>
...
$empid = $row['Emp_ID'];
  ...
  if(mysqli_num_rows($result2) == 0) {
    echo "<td><a href='pay_staff.php?Emp_ID=".$row['Emp_ID']."'><img src='./images/icons8-currency-exchange-32.png' alt='Edit'></a></td>";
  } else {
