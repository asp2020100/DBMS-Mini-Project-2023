...
<form action="service_update.php" method="POST">
  ...
  <?php
	...
	$result2 = mysqli_query($mysqli,"SELECT * FROM SERVICE_PERSONNAL WHERE Emp_ID ='$id'");
	while($row2 = mysqli_fetch_array($result2))
	{
  	echo"<label><b>Area</b>";
    echo"<input type='text' name='area' value='{$row2['Area']}'required>";
	echo"<label><b>Type</b>";
	echo"<input type='text' name='type' value='{$row2['Type']}'required>";
    echo"</label>";
