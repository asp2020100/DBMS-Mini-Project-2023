...
<a href="manager_registration.php"><div class="round-button" style="float:right; margin-right:40px;"><i class="fa fa-plus"></i> | Add User</div></a>
Account Information - Manager</h3>
...
echo "<td><a href='manager_edit.php?Emp_ID=".$row['Emp_ID']."'><img src='./images/icons8-Edit-32.png' alt='Edit'></a></td>";
echo "<td><a href='manager_delete.php?Emp_ID=".$row['Emp_ID']."'><img src='./images/icons8-Trash-32.png' alt='Delete'></a></td>";
