<?php
session_start();
$query = "SELECT * FROM SYS_ADMIN WHERE Email = '" . $_SESSION['user'] . "'";
...
<h3 style="font-family:Montserrat;margin-left:5%;">Modify admin Details</h3>
...
echo "<td><a href='credential_edit.php?Email=".$row['Email']."'><img src='./images/icons8-Edit-32.png' alt='Edit'></a></td>";
